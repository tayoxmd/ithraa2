        ...
        <div className="space-y-4 pt-4">
          {mode === 'main' && (
            <>
              ...
              <Button
                className="w-full h-14 text-lg bg-[#1a3a5c] hover:bg-[#0f2942] text-white"
                onClick={() => setMode('login')}
              >
                {t({ ar: "إنشاء حساب جديد", en: "Create New Account" })}
              </Button>
            </>
          )}
