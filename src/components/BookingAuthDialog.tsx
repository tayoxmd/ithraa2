        ...
        <div className="space-y-4 pt-4">
          {mode === 'main' && (
            <>
                ...
                {/* WhatsApp Login Button (Temporary/Placeholder) */}
                <Button
                  variant="outline"
                  className="w-full h-14 text-lg gap-3 opacity-60 cursor-not-allowed"
                  disabled
                >
                  ...
                  {t({ ar: "التحقق عبر واتساب (قريباً)", en: "WhatsApp Verification (Soon)" })}
                </Button>
