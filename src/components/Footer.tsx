      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex items-center justify-center gap-6 mb-8">
          {settings.facebook_url && (
            <a href={settings.facebook_url} target="_blank" rel="noopener noreferrer" className="text-white hover:text-primary transition-colors">
              <Facebook className="w-8 h-8" />
            </a>
          )}
          {settings.twitter_url && (
            <a href={settings.twitter_url} target="_blank" rel="noopener noreferrer" className="text-white hover:text-primary transition-colors">
              <Twitter className="w-8 h-8" />
            </a>
          )}
          {settings.instagram_url && (
            <a href={settings.instagram_url} target="_blank" rel="noopener noreferrer" className="text-white hover:text-primary transition-colors">
              <Instagram className="w-8 h-8" />
            </a>
          )}
          {settings.whatsapp_number && (
            <a href={`https://wa.me/${settings.whatsapp_number.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-white hover:text-primary transition-colors">
