...
export default function Auth() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        const { error } = await signUp(emailToUse, password, fullName, fullPhone, redirectUrl || undefined);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-primary via-primary-glow to-primary">
      <Card className="w-full max-w-md bg-card shadow-luxury border-0 rounded-2xl">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <>
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">({t({ ar: "اختياري", en: "Optional" })})</span>
                  </div>
                  <Input
                    id="email"
                    type="email"
            ...
            <Button type="submit" className="w-full btn-luxury h-11" disabled={loading}>
              {loading ? (
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-muted-foreground">{t({ ar: "أو", en: "Or" })}</span>
              </div>
            </div>
      ...
      <WhatsAppAuth open={whatsappAuthOpen} onOpenChange={setWhatsappAuthOpen} redirectUrl={redirectUrl || undefined} />
