-- Fix function overloading conflict: delete ALL versions and recreate with single signature
-- This resolves "Could not choose best candidate" error

-- Drop ALL existing variations (safe with IF EXISTS)
...
-- Recreate with single consistent signature: active_only first, city_id second
